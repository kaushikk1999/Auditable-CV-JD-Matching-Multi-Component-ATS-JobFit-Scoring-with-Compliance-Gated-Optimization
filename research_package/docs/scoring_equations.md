...
#### 1.4 BM25 Document Similarity (S_bm25)
Full-document ranking score.


S_bm25 = BM25(CV_text, JD_text, corpus={JD_text})
text
...
ATS = w1·C_lex + w2·C_fuzzy + w3·R_tfidf + w4·S_bm25 + w5·Q_section
text
...
- w4 = 0.20 (full-document similarity)
...
- **BM25:** rank-bm25 0.2.2, k1=1.5, b=0.75

...
**Current State:** No LICENSE file exists; see [`docs/dataset_provenance.md`](./dataset_provenance.md) for details

> [!WARNING]
> The main README currently claims "MIT License" but no LICENSE file exists in the repository. This discrepancy should be resolved.
